  ...
  const contactMethods = [
    {
      ...
      value: "+91 9117-770-110",
      action: "tel:+919117770110",
      label: "Call Now",
    },
    {
      icon: MessageCircle,
      ...
      value: "+91 9117-770-110",
      action: "https://wa.me/919117770110",
    ...
    },
    {
      ...
      description:
        "Submit your service request and we’ll call you back shortly.",
      value: "24/7 Available",
      action:
        "https://docs.google.com/forms/d/e/1FAIpQLSfxUe06nbktS-tsgtbIo9NTuJ4bk8jAuiUdaW3DQ7RZm1AgGg/viewform?usp=header",
      label: "Book Now",
    },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Contact us via phone, WhatsApp, or email with your appliance
                issue.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                We'll confirm your location, appliance type, and schedule an
                appointment.
              </p>
            </div>
            <div className="text-center">
