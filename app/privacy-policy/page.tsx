        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Hindustan Care ("Company", "we", "our", or "us") operates the
              Hindustan Care website and mobile application. This page informs
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              <li>
                <strong>Personal Data:</strong> Phone number, email address,
                name, address, and location information
              </li>
              <li>
              ...
              <li>
                <strong>Cookie Data:</strong> Information stored in cookies and
